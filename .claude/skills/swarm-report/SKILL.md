...
oak swarm status
oak swarm nodes
oak swarm search "recent changes" --type all -n 20
oak swarm search "shared dependencies" --type memory -n 20
oak swarm search "coding conventions" --type memory -n 20
```

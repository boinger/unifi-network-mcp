...
oak swarm status
oak swarm nodes
oak swarm search "utility functions common patterns" --type all -n 20
oak swarm search "architectural patterns" --type memory -n 20
oak swarm search "error handling patterns" --type memory -n 15
```
